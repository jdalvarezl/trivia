...
twelfthButton.addEventListener('click', () => {
    ...
    if (resultsOfMinecraft.length === 3) {
        document.getElementById('important-h2').style.display = "block"
        document.getElementById('correctAnswersOfMinecraft').style.display = "block"
        document.getElementById('correctAnswersOfMinecraft').innerHTML = corrrectAnswersOfMinecraft
